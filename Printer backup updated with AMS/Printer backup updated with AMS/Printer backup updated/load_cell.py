...
class LoadCellGuidedCalibrationHelper:
    ...
    def cmd_CALIBRATE(self, gcmd):
        ...
        # 2. CHECK IF TARE AND CALIBRATION ARE IDENTICAL
        ...
        # 3. BYPASS 1% CHECK (Commented out)
        ...
        # 4. ASSIGN FINAL VALUE (Must be AFTER the checks but BEFORE the warnings)
        self._counts_per_gram = c_per_g

        # 5. GIVE CAPACITY WARNINGS
        if cap_kg < 1.:
